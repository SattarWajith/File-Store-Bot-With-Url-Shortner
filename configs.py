...
class Config(object):
  ...
  DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://ironfista:T519G5MEr3364HI1@cluster0.demdt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
